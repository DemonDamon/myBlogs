...
**代码实现参考**：[ReMe](https://github.com/agentscope-ai/ReMe/blob/main/reme/reme_fs.py)。
...
目前支持 SQLite 和 Chroma 两种后端实现。由于在 macOS 14 及更低版本上 SQLite 向量扩展存在卡死和闪退的问题，**当前仅开放 Chroma 作为默认数据库后端**。
...
* [项目介绍](/docs/intro.zh) — 这个项目可以做什么
* [控制台](/docs/console.zh) — 在控制台管理记忆与配置
* [Skills](/docs/skills.zh) — 内置与自定义能力
* [配置与工作目录](/docs/config.zh) — 工作目录与 config