...
> **看不到控制台？** 请确认前端已构建，构建方式见 [CLI](/docs/cli)。
...
> 各平台的凭据获取步骤，请看 [频道配置](/docs/channels)。
...
1. 在提供商卡片下方的 **LLM** 区域，从下拉菜单选择一个 **提供商**（只显示已授权的）。
2. 选择或输入 **模型** 名称。
3. 点 **Save**。
...
>
> 提供商详细说明见 [配置 — 模型提供商](/docs/config#%E6%A8%A1%E5%9E%8B%E6%8F%90%E4%BE%9B%E5%95%86)。
...
>
> 更多说明见 [配置 — 环境变量](/docs/config#%E7%8E%AF%E5%A2%83%E5%8F%98%E9%87%8F)。
...
* [配置与工作目录](/docs/config) —— 配置字段、提供商、环境变量
* [频道配置](/docs/channels) —— 各频道的接入步骤和凭据获取
* [技能](/docs/skills) —— 内置技能说明和自定义技能编写
* [心跳](/docs/heartbeat) —— 心跳配置
* [CLI](/docs/cli) —— 命令行参考