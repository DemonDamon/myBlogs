...
# GitHub - HKUDS/CLI-Anything: CLI-Anything: Making ALL Software Agent-Native · GitHub
...
* [Notifications](/login?return_to=%2FHKUDS%2FCLI-Anything) You must be signed in to change notification settings
* [Fork
  998](/login?return_to=%2FHKUDS%2FCLI-Anything)
* [Star
   11.7k](/login?return_to=%2FHKUDS%2FCLI-Anything)

# HKUDS/CLI-Anything

main

[Branches](/HKUDS/CLI-Anything/branches)[Tags](/HKUDS/CLI-Anything/tags)
...
| --- | --- | --- | --- | --- |
| Latest commit   History[56 Commits](/HKUDS/CLI-Anything/commits/main/)   56 Commits | | |
| [.claude-plugin](/HKUDS/CLI-Anything/tree/main/.claude-plugin ".claude-plugin") | | [.claude-plugin](/HKUDS/CLI-Anything/tree/main/.claude-plugin ".claude-plugin") |  |  |
| [anygen/agent-harness](/HKUDS/CLI-Anything/tree/main/anygen/agent-harness "This path skips through empty directories") | | [anygen/agent-harness](/HKUDS/CLI-Anything/tree/main/anygen/agent-harness "This path skips through empty directories") |  |  |
| [assets](/HKUDS/CLI-Anything/tree/main/assets "assets") | | [assets](/HKUDS/CLI-Anything/tree/main/assets "assets") |  |  |
| [audacity/agent-harness](/HKUDS/CLI-Anything/tree/main/audacity/agent-harness "This path skips through empty directories") | | [audacity/agent-harness](/HKUDS/CLI-Anything/tree/main/audacity/agent-harness "This path skips through empty directories") |  |  |
| [blender/agent-harness](/HKUDS/CLI-Anything/tree/main/blender/agent-harness "This path skips through empty directories") | | [blender/agent-harness](/HKUDS/CLI-Anything/tree/main/blender/agent-harness "This path skips through empty directories") |  |  |
| [cli-anything-plugin](/HKUDS/CLI-Anything/tree/main/cli-anything-plugin "cli-anything-plugin") | | [cli-anything-plugin](/HKUDS/CLI-Anything/tree/main/cli-anything-plugin "cli-anything-plugin") |  |  |
| [codex-skill](/HKUDS/CLI-Anything/tree/main/codex-skill "codex-skill") | | [codex-skill](/HKUDS/CLI-Anything/tree/main/codex-skill "codex-skill") |  |  |
| [drawio/agent-harness](/HKUDS/CLI-Anything/tree/main/drawio/agent-harness "This path skips through empty directories") | | [drawio/agent-harness](/HKUDS/CLI-Anything/tree/main/drawio/agent-harness "This path skips through empty directories") |  |  |
| [gimp/agent-harness](/HKUDS/CLI-Anything/tree/main/gimp/agent-harness "This path skips through empty directories") | | [gimp/agent-harness](/HKUDS/CLI-Anything/tree/main/gimp/agent-harness "This path skips through empty directories") |  |  |
| [inkscape/agent-harness](/HKUDS/CLI-Anything/tree/main/inkscape/agent-harness "This path skips through empty directories") | | [inkscape/agent-harness](/HKUDS/CLI-Anything/tree/main/inkscape/agent-harness "This path skips through empty directories") |  |  |
| [kdenlive/agent-harness](/HKUDS/CLI-Anything/tree/main/kdenlive/agent-harness "This path skips through empty directories") | | [kdenlive/agent-harness](/HKUDS/CLI-Anything/tree/main/kdenlive/agent-harness "This path skips through empty directories") |  |  |
| [libreoffice/agent-harness](/HKUDS/CLI-Anything/tree/main/libreoffice/agent-harness "This path skips through empty directories") | | [libreoffice/agent-harness](/HKUDS/CLI-Anything/tree/main/libreoffice/agent-harness "This path skips through empty directories") |  |  |
| [obs-studio/agent-harness](/HKUDS/CLI-Anything/tree/main/obs-studio/agent-harness "This path skips through empty directories") | | [obs-studio/agent-harness](/HKUDS/CLI-Anything/tree/main/obs-studio/agent-harness "This path skips through empty directories") |  |  |
| [opencode-commands](/HKUDS/CLI-Anything/tree/main/opencode-commands "opencode-commands") | | [opencode-commands](/HKUDS/CLI-Anything/tree/main/opencode-commands "opencode-commands") |  |  |
| [qoder-plugin](/HKUDS/CLI-Anything/tree/main/qoder-plugin "qoder-plugin") | | [qoder-plugin](/HKUDS/CLI-Anything/tree/main/qoder-plugin "qoder-plugin") |  |  |
| [shotcut/agent-harness](/HKUDS/CLI-Anything/tree/main/shotcut/agent-harness "This path skips through empty directories") | | [shotcut/agent-harness](/HKUDS/CLI-Anything/tree/main/shotcut/agent-harness "This path skips through empty directories") |  |  |
| [zoom/agent-harness](/HKUDS/CLI-Anything/tree/main/zoom/agent-harness "This path skips through empty directories") | | [zoom/agent-harness](/HKUDS/CLI-Anything/tree/main/zoom/agent-harness "This path skips through empty directories") |  |  |
| [.gitignore](/HKUDS/CLI-Anything/blob/main/.gitignore ".gitignore") | | [.gitignore](/HKUDS/CLI-Anything/blob/main/.gitignore ".gitignore") |  |  |
| [README.md](/HKUDS/CLI-Anything/blob/main/README.md "README.md") | | [README.md](/HKUDS/CLI-Anything/blob/main/README.md "README.md") |  |  |
| [README\_CN.md](/HKUDS/CLI-Anything/blob/main/README_CN.md "README_CN.md") | | [README\_CN.md](/HKUDS/CLI-Anything/blob/main/README_CN.md "README_CN.md") |  |  |
| View all files | | |
...
[![Quick Start](images/5e086ca8138932145f91895f10800eb9.jpg)](#-quick-start)
[![Demos](images/27bc0081212ebca1bad43292f66e4a43.jpg)](#-demonstrations)
[![Tests](images/3c50f64bb7b03f338a7ccda5bfd0bc27.jpg)](#-test-results)
[![License](images/f41646371a13fe978fd24971e3e8b292.jpg)](/HKUDS/CLI-Anything/blob/main/LICENSE)

[![Python](images/62ae86a65975f80e29ff3769fe05d64c.jpg)](images/62ae86a65975f80e29ff3769fe05d64c.jpg)
[![Click](images/3bbadddabd9b2aa38481154d92d779f1.jpg)](images/3bbadddabd9b2aa38481154d92d779f1.jpg)
[![Pytest](images/b700bef630a0af9eddac8381ca5780b4.jpg)](images/b700bef630a0af9eddac8381ca5780b4.jpg)
[![Coverage](images/cd304e65aa77e50f631edd2d8e3042b4.jpg)](images/cd304e65aa77e50f631edd2d8e3042b4.jpg)
[![Output](images/8dbf2a696173911f0ab6916aea3f76c6.jpg)](images/8dbf2a696173911f0ab6916aea3f76c6.jpg)
[![Feishu](images/6cc175b039e7f449410b0e852213df46.jpg)](https://github.com/HKUDS/.github/blob/main/profile/README.md)
[![WeChat](images/3d7948acb28678b1252ad0d4b61d815b.jpg)](https://github.com/HKUDS/.github/blob/main/profile/README.md)

**One Command Line**: Make any software agent-ready for OpenClaw, nanobot, Cursor, Claude Code, etc.  [**中文文档**](/HKUDS/CLI-Anything/blob/main/README_CN.md)

[![CLI-Anything typing demo](/HKUDS/CLI-Anything/raw/main/assets/cli-typing.gif)](/HKUDS/CLI-Anything/blob/main/assets/cli-typing.gif)

[![CLI-Anything Teaser](images/6d311563391e3cd575b90b4390d42664.png)](/HKUDS/CLI-Anything/blob/main/assets/teaser.png)
...
| **🤖 AI/ML Platforms** | Automate model training, inference pipelines, and hyperparameter tuning through structured commands | Stable Diffusion WebUI, ComfyUI, InvokeAI, Text-generation-webui, Open WebUI, Fooocus, Kohya\_ss, AnythingLLM, SillyTavern |
...
[![CLI-Anything Architecture](images/b98e5b2a94fa9d89fee50b69c32651cc.png)](/HKUDS/CLI-Anything/blob/main/assets/architecture.png)
...
> See the full methodology: [`cli-anything-plugin/HARNESS.md`](/HKUDS/CLI-Anything/blob/main/cli-anything-plugin/HARNESS.md)
...
* **New software targets** — Use the plugin to generate a CLI for any software with a codebase, then submit your harness via [`cli-anything-plugin/PUBLISHING.md`](/HKUDS/CLI-Anything/blob/main/cli-anything-plugin/PUBLISHING.md).
...
| --- | --- |
| [`cli-anything-plugin/HARNESS.md`](/HKUDS/CLI-Anything/blob/main/cli-anything-plugin/HARNESS.md) | The methodology SOP — single source of truth |
| [`cli-anything-plugin/README.md`](/HKUDS/CLI-Anything/blob/main/cli-anything-plugin/README.md) | Plugin documentation — commands, options, phases |
| [`cli-anything-plugin/QUICKSTART.md`](/HKUDS/CLI-Anything/blob/main/cli-anything-plugin/QUICKSTART.md) | 5-minute getting started guide |
| [`cli-anything-plugin/PUBLISHING.md`](/HKUDS/CLI-Anything/blob/main/cli-anything-plugin/PUBLISHING.md) | Distribution and publishing guide |
...
[![Star History Chart](images/d407ed94a552bfeda2bd44b6ba40f2d4.jpg)](images/577331c3afbd5f933a7fc17f9b8e4220.jpg)
...
[![CLI-Anything Icon](images/92d7b42ae270a29c0fe35eed06a424c0.png)](/HKUDS/CLI-Anything/blob/main/assets/icon.png)

*Thanks for visiting ✨ CLI-Anything!*

[![Views](images/c107f5380c987c5dacb2fcffb3b6c91d.jpg)](images/c107f5380c987c5dacb2fcffb3b6c91d.jpg)
...
[Activity](/HKUDS/CLI-Anything/activity)

[Custom properties](/HKUDS/CLI-Anything/custom-properties)

### Stars

[**11.7k**
stars](/HKUDS/CLI-Anything/stargazers)

### Watchers

[**69**
watching](/HKUDS/CLI-Anything/watchers)

### Forks

[**998**
forks](/HKUDS/CLI-Anything/forks)

[Report repository](/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2FHKUDS%2FCLI-Anything&report=HKUDS+%28user%29)

## [Releases](/HKUDS/CLI-Anything/releases)

No releases published

## [Packages 0](/orgs/HKUDS/packages?repo_name=CLI-Anything)

### Uh oh!

There was an error while loading. Please reload this page.

## [Contributors](/HKUDS/CLI-Anything/graphs/contributors)
...
* [Python
  99.4%](/HKUDS/CLI-Anything/search?l=python)
* Other
  0.6%